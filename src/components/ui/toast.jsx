  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        {
          "bg-card-bg border-border text-primary": variant === "default",
          "bg-green-500/20 border-green-500 text-green-400": variant === "success",
          "bg-red-500/20 border-red-500 text-red-400": variant === "destructive",
          "bg-yellow-500/20 border-yellow-500 text-yellow-400": variant === "warning",
        },
        className
      )}
      {...props}
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-secondary opacity-0 transition-opacity hover:text-primary focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100",
      className
    )}
    toast-close=""
    {...props}
